                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{asset('admin-panel/assets/images/logo-icon.png')}}" alt="homepage"
                                class="light-logo" />
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="{{asset('admin-panel/assets/images/logo-text.png')}}" alt="homepage"
                                class="light-logo" />
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="#">الاجراءات</a>
                        ...
                        <li class="nav-item search-box"> <a class="nav-link waves-effect waves-dark"
                            ...
                            <form class="app-search position-absolute">
                                <input type="text" class="form-control" placeholder="بحث&amp; enter"> <a
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href=""
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img
                                    src="{{asset('admin-panel/')}}assets/images/users/1.jpg" alt="user"
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <div class="p-l-30 p-10"><a href="javascript:void(0)"
                                        class="btn btn-sm btn-success btn-rounded">عرض Profile</a></div>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                ...
                                <li class="sidebar-item"><a href="pages-calendar.html" class="sidebar-link"><i
                                            class="mdi mdi-calendar-check"></i><span class="hide-menu"> التقويم
                                        </span></a></li>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"><strong>اضافة حدث</strong></h4>
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <label class="control-label">Choose Category لون الحدث</label>
