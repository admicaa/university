                        ...
                        <form action="{{route('user.search')}}" method="GET" class="form-horizontal">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-3 text-left control-label col-form-label">بحث ب اسم
                                        الموظف</label>
                                    <div class="col-sm-9">
                            ...
                            <div class="border-top">
                                <div class="card-body">
                                    ...
                                    <a href="{{route('user')}}" class="btn btn-md btn-danger">ازالة الفلاتر</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <h5 class="card-title m-b-0">المستخدمين</h5>
                                </div>
                                <div class="col-6 d-flex justify-content-end">
                                    <a class="btn btn-lg btn-dark" href="{{route('user.create')}}">اضافة موظف او
                                        مستخدم</a>
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('uploads/gallery/' . $user->image) }}" width="80px"
                                                height="80px" alt="صورة المستخدم"> </td>
                                        <td>{{$user->role}}</td>
                                        <td>{{$user->email}}</td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" username="{{$user->username}}" role="{{$user->role}}"
                                                ...
                                                class="view-data btn btn-sm btn-success">عرض</button>
                                            <a href="{{route('user.edit',$user->id)}}"
                                                class="btn btn-sm btn-dark">تعديل</a>
                                            {{--<a href="{{route('managesalary.detail',$user->id)}}"
                                                class="btn btn-sm btn-warning">المدفوعات</a>--}}
                                            <a href="{{route('managesalary.detail',$user->id)}}"
                                                class="btn btn-sm btn-warning">المدفوعات</a>
