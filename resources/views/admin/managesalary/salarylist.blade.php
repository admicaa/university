                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><a
                                        href="{{route('managesalary')}}">Manage Salary</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                                ...
                                <table id="zero_config" class="table table-striped table-bordered salarylist">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{--<a href="" class="btn btn-sm btn-dark">تعديل</a>--}}
                                                <a href="{{route('managesalary.makepayment')}}"
                                                    class="btn btn-sm btn-danger">Generate payslip</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    @endforeach
