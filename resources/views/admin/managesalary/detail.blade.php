...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form action="{{route('managesalary.detail',$user->id)}}" method="GET"
                        class="form-horizontal no-print">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date " id="startDate">
                                    <strong>From</strong>
                                    <input type='date' value="{{request()->startdate}}" name="startdate"
                                        class="form-control" />
                                </div>
                                <!-- Time Picker -->
                                <div class="input-group date" id="startTime">
                                    <strong>To</strong>
                                    <input type='date' value="{{request()->enddate}}" name="enddate"
                                        class="form-control" />
                                </div>
                                <div class="input-group date" id="search">
                                    ...
                                    <a href="{{route('managesalary.detail',$user->id)}}"
                                        class="btn btn-md btn-danger">ازالة الفلاتر</a>
                                </div>
                            </div>
                        </div>
                        <br><br>
        ...
        <div class="row no-print">
            <div class="col-12">
                {{--<a href="" id="pdffile" target="-_blank" class="btn btn-default"><i class="fa fa-print"></i>Print
                </a>--}}
        ...
        <div class="row ">
                ...
                <div class="card">
                    <form action="{{route('managesalary.store')}}" method="post" class="form-horizontal">
                        ...
                        <dl class="row employeedetails">
                            <dt class="col-sm-5">اسم الموظف:</dt>
                            <dd class="col-sm-7" name="employee_name" id="employee_name">
                            ...
                            <dd class="col-sm-7" name="advance" id="advance">{{$advanceالمدفوعات->total}} </dd>
                        ...
                        {{--<div class="card-body">--}}
                            ...
                            {{--<div class="form-group row">--}}
                                {{--<label for="lname" class="col-sm-3 text-left control-label col-form-label">Total
                                    number of working days</label>--}}
                                {{--<div class="col-sm-5">--}}
                                    {{--<input type="text" name="working_days" id="days" value="30"
                                        class="form-control">--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            {{--<div class="form-group row">--}}
                                {{--<label for="fname" class="col-sm-3 text-left control-label col-form-label">Rate
                                    per day</label>--}}
                                {{--<div class="col-sm-5">--}}
                            ...
                            {{--<div class="form-group row">--}}
                                {{--<label for="fname" class="col-sm-3 text-left control-label col-form-label">Gross
                                    pay</label>--}}
                                {{--<div class="col-sm-5">--}}
                        ...
                        {{--<div class="card-body">--}}
                            ...
                            {{--<div class="form-group row">--}}
                                {{--<label for="lname" class="col-sm-3 text-left control-label col-form-label">Tax
                                    %</label>--}}
                                {{--<div class="col-sm-5">--}}
                                    {{--<input type="text" name="tax_deduction" class="form-control" value=""
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <form action="{{route('managesalary.makeadvance')}}" method="post"
                        class="form-horizontal advance-pay">
                        @csrf
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="lname"
                                    class="col-sm-3 text-left control-label col-form-label">Amount</label>
                                <div class="col-sm-5">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Advance payment lists</h5>
                        <hr />
